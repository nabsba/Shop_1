...
const function_2 = require("../model/service/Common/logic/functions/function");
...
router.get('/image/product/:type/:sizePic/:colorFolder/:nameProduct/:namePic', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        (0, function_2.logMessage)(JSON.stringify(`/image/product/:type/:sizePic/:colorFolder/:nameProduct/:namePic, error: -> ${error}`));
        res.send(false);
    }
}));
router.get('/image/product/:type/:sizePic/general/:namePic', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        (0, function_2.logMessage)(`fileManager/get/image/product/:type/:sizePick/general/:namePic -> error: ${error}`);
        res.send(false);
    }
}));
router.get('/numberOfPic/:type/:sizePic/:colorFolder/:nameProduct', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        (0, function_2.logMessage)(`/numberOfPic/:type/:sizePic/:colorFolder/:nameProduct -> error: ${error}`);
        res.send(false);
    }
}));
