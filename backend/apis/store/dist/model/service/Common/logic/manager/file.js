...
const createDirectoryIfNot = (directory) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        (0, function_1.logMessage)(`${(0, constant_1.ERROR_LOG_ASYNC_MESSAGE)('manager/file.ts', 'createDirectoryIfNot')},
			${error}`);
    }
    finally {
        return result;
...
const readFileData = (folderPath) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        (0, function_1.logMessage)(`${(0, constant_1.ERROR_LOG_ASYNC_MESSAGE)('manager/file.ts', 'readFileData')},
			${error}`);
        return result;
    }
});
...
const writeFileData = (folderPath, object) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        result.serverError = true;
        result.errorMessage = error;
        (0, function_1.logMessage)(`${(0, constant_1.ERROR_LOG_ASYNC_MESSAGE)('manager/file.ts', 'writeFileData')},${error}`);
    }
    finally {
        return result;
    }
